...
public class FXMLSkladController implements Initializable{
       ...
       if (event.getSource()==ButtonNext){
          try {
            if (rs.next()) {
                ...
                Kol_vo.setText(rs.getString("Kol_vo"));
            ...
            Logger.getLogger(FXMLSkladController.class.getName()).log(Level.SEVERE, null, ex);
        }}
       else{
       try {
            if (rs.previous()) {
